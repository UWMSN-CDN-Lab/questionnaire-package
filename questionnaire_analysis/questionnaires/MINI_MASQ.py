...
def MASQ_process_data(df):
    ...
    # All MASQ columns for numeric conversion
    all_masq_columns = list(set(masq_gd_columns + masq_aa_columns + masq_ad_forward_columns + masq_ad_reverse_columns))

    # Convert all columns to numeric FIRST
    for col in all_masq_columns:
